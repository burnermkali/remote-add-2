...
<head>
    ...
    <title>NIS Sunday Basketball Till Number: 6219447-Shiks</title>
...
if(isset($_POST['submit'])){
    ...
    $amount = '400'; //Amount to transact 
    $phonenumber = $_POST['phone-number']; // Phone number paying
    
    $Account_no = '6219447'; // Enter account number optional
    $url = 'url endpoint dont run this https://tinypesa.com/6219447';
    $data = array(
        'amount' => $amount,
        'msisdn' => $phonenumber,
    ...
    if ($msg_resp ->success == 'true') {
        echo "WAIT FOR  STK POP UP, and enter pin, then confirm with shiks";
      } else {
